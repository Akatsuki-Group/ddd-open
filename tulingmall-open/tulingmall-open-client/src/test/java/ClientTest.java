...
public class ClientTest {
    public static void main(String[] args) throws Exception {
        ...
        //一、基础参数部分
        //服务提供地址
        ftClient.setEndPoint("http://localhost:8711/tlmallOpen/gsInterfaceAsync");
//        ftClient.setEndPoint("http://localhost:8888/tlmallOpen/gsInterfaceSync");
...
//        reqHeader.setSysPwd("testPwd");
        ...
        reqHeader.setTransId("20221214221003");
        //服务功能码-查询手机号码标注
//        reqHeader.setServiceCode("search_mobile_mark");
        ...
        reportbody.put("mobile", "18472617343");
